...
public class HowToPassTestsQueryHandler implements QueryHandler {
    ...
    public void handle(UserRequest request) {
        ...
        sendHelpMessage.sendHelpMessage(request.getChatId(), "how_to_tests", lang);
    }

    @Override
    public String getCallbackQuery(String lang) {
        if (lang.equals("en")) return "How to pass tests?";
        else return "Як проходити тести?";
    }
