...
import com.example.telegramapi.components.sup.tab.NotYetComponent;
...
public class TestTabTextHandler implements TextHandler {
    ...
    private final NotYetComponent notYetComponent;
    ...
    public void handle(UserRequest request) {
        ...
        if (message.equals("➕ New word list")
                ...
                || message.equals("🚀 Запустити випадковий тест")) notYetComponent.sendMessage(request);
